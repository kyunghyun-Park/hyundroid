...
import com.kh.myweather0812.fregment.WeatherFregment2;
import com.kh.myweather0812.fregment.WeatherFragment;

public class MainActivity extends AppCompatActivity {
    BottomNavigationView bnv;
    WeatherFragment weatherFragment;
    WeatherFregment2 weatherFregment2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherFregment2 = new WeatherFregment2();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.tab2:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.container, weatherFregment2).commit();
                        return true;
