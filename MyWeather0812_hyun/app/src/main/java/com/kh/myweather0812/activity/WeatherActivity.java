    ...
    private class GetXmlTask extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document document) {
            ...
            for (int i = 0; i < weatherArrList.size(); i++) {
                Log.d("WeatherActivity", "날짜: " + weatherArrList.get(i).getTime());
                Log.d("WeatherActivity", "온도: " + weatherArrList.get(i).getTemp());
                Log.d("WeatherActivity", "날씨: " + weatherArrList.get(i).getWeather());
