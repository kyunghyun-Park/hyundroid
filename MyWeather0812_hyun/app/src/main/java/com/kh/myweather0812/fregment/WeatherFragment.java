...
//    TextView weatherInfo1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        koreanImg=rootView.findViewById(R.id.koreanImg);
        // fregment layout 연결
//        weatherStart1 = rootView.findViewById(R.id.startWeather1);
//        weatherInfo1 = rootView.findViewById(R.id.weatherInfo1);
//        weatherStart1.setOnClickListener(new View.OnClickListener() {
//            @Override
